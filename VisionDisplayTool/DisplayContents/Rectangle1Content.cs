...
{
   public class Rectangle1Content:ContentBase
    {
        ...
        public Rectangle1Content()
        {

        }
        public Rectangle1Content(string name, HWindow window, double row1, double col1, double row2, double col2, string color = "green", int lineWidth = 1) : base(name,window)
        {
            this.Row1 = row1;
            this.Col1 = col1;
            this.Row2 = row2;
