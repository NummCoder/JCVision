...
{
    public class BaslerCameraInfo : IVisionCameraInfo
    {
        ...
        public string HeartbeatTime { get; set; } = "200";  //图像的心跳时间
        ...
        public BaslerCameraInfo()
        {
            _CameraType = CameraType.Basler;
        }
        public BaslerCameraInfo(string camName)
        {
            UserID = camName;
            _CameraType = CameraType.Basler;
        }
